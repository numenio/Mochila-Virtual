...
Begin VB.Form frmTítuloEvaluación 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Título de la evaluación"
   ClientHeight    =   1710
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7860
   Icon            =   "frmTítuloEvaluación.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmTítuloEvaluación.frx":08CA
   ScaleHeight     =   1710
   ScaleWidth      =   7860
   ...
   Begin TransparentButton.ButtonTransparent ButtonTransparent1 
      ...
      _ExtentX        =   7011
      _ExtentY        =   873
      Caption         =   "Guardar el título de la evaluación"
      EstiloDelBoton  =   0
      OriginalPicSizeW=   0
      OriginalPicSizeH=   0
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      Enabled         =   -1  'True
      MaxLength       =   64
      TextRTF         =   $"frmTítuloEvaluación.frx":2922
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "Escribir un título a la evaluación para después encontrarla fácilmente:"
      ForeColor       =   &H00FFFFFF&
      Height          =   255
      Left            =   210
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmTítuloEvaluación"
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If Shift And 7 = vbCtrlMask And KeyCode = vbKeyF1 Then 'leer la ayuda del cuaderno
         frmAyuda.formulario = formularios.títuloEvaluación
         frmAyuda.Show
         Exit Sub
    End If
...
Private Sub Form_Load()
    ...
    Decir "Escribile un título a tu evaluación para que más tarde puedas encontrarla más fácilmente"
    archivoGuardado = False
End Sub

Private Sub Form_Unload(Cancel As Integer)
    If archivoGuardado = False Then 'si no ha guardado la hoja, se impide cerrar la ventana
        Decir "no has escrito ningún título a tu evaluación, escribí uno y apretá enter"
        Cancel = 1
    End If
End Sub
