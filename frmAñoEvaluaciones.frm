...
Begin VB.Form frmAñoEvaluaciones 
   Caption         =   "Evaluaciones realizadas"
   ClientHeight    =   5520
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4155
   Icon            =   "frmAñoEvaluaciones.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmAñoEvaluaciones.frx":08CA
   ScaleHeight     =   5520
   ScaleWidth      =   4155
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   4140
      ItemData        =   "frmAñoEvaluaciones.frx":2922
      Left            =   150
      List            =   "frmAñoEvaluaciones.frx":2924
      TabIndex        =   0
      Top             =   240
      Width           =   3855
   End
   Begin TransparentButton.ButtonTransparent Command1 
      ...
      _ExtentX        =   5741
      _ExtentY        =   1085
      Caption         =   " Mostrar las evaluaciones del año seleccionado"
      EstiloDelBoton  =   1
      Picture         =   "frmAñoEvaluaciones.frx":2926
   ...
   End
End
Attribute VB_Name = "frmAñoEvaluaciones"
...
'        frmPrincipal.Show
    ...
    If shiftkey = vbCtrlMask And KeyCode = vbKeyF1 Then 'leer la ayuda del cuaderno
         frmAyuda.formulario = formularios.añoEvaluaciones
         frmAyuda.Show
         Exit Sub
    End If
End Sub
...
Private Sub Form_Load()
    ...
    Decir "Entrando en los años que tienen evaluaciones de " + swMateria + ". Elegí con las flechas cuál año querés abrir y aceptá con enter"
...
'                End If
        ...
        End If
    Next
    If List1.ListCount = 0 Then List1.AddItem "No hay ninguna evaluación guardada"
    List1.ListIndex = 0
End Sub
...
Private Sub List1_DblClick()
    If List1.List(List1.ListIndex) <> ("No hay ninguna evaluación guardada") And List1.ListIndex <> -1 Then
        frmMesEvaluaciones.añoParaVerMeses = Trim(Right(List1.List(List1.ListIndex), 4))
        frmMesEvaluaciones.swMateria = swMateria
